...
class ShaderProgram {
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifTexture    = gl.getUniformLocation(this.prog, "u_Texture2D");
    this.unifTexture2    = gl.getUniformLocation(this.prog, "u_Texture");
  ...
  setTexture(slot: number){
    ...
    if(slot == 1){
      if (this.unifTexture2 !== -1) {
        gl.uniform1i(this.unifTexture2, slot);
      }
    }
  }
